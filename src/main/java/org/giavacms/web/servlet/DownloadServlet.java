package org.giavacms.web.servlet;
...
/**
 * Mappare la seguente servlet su un url del tipo
 * 
 * http://b28:8080/gestionefalsi/download/163/esempio.pdf
 * 
 * @author pisi79
 * 
 */
abstract public class DownloadServlet<T> extends HttpServlet
{
   ...
   {
      DownloadServlet d = new DownloadServlet()
      {
         protected byte[] getBytes(Object object, HttpServletRequest req, HttpServletResponse resp)
         {
            return null;
         }

         protected Object fetch(String id, HttpServletRequest req, HttpServletResponse resp)
         {
            return null;
         }
      };
   ...
   private static void print(DownloadServlet d, String ext)
   {
      System.out.println(ext + "\t" + d.getContentType(null, "file." + ext));
   }
}
